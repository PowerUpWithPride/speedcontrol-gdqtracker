...
function updateDonationTotalFromAPI() {
    let url = nodecg.bundleConfig.url + "/" + nodecg.bundleConfig.eventId + "?json";
...
function updateBids() {
    let url = nodecg.bundleConfig.url + "/search?event=" + nodecg.bundleConfig.eventId + "&type=allbids&state=OPENED";
